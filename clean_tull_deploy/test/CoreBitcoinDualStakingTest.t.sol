...
contract CoreBitcoinDualStakingTest is Test {
    ...
    function setUp() public {
        // Deploy tokens
        coreToken = new SimpleToken("Core Token", "CORE", 18, INITIAL_SUPPLY);
        btcToken = new SimpleToken("Bitcoin Token", "BTC", 18, INITIAL_SUPPLY);
        ...
        // Transfer tokens to operator for reward pools
        coreToken.transfer(operator, 50000 * 1e18);
        btcToken.transfer(operator, 50 * 1e18);

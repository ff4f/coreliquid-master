...
export const CONTRACT_ADDRESSES = {
  // Core Tokens - REAL DEPLOYED ADDRESSES
  CORE_LIQUID_TOKEN: process.env.NEXT_PUBLIC_CORE_LIQUID_TOKEN || '0x162ff7e6202d6765290E58932EABA20Cc26939AF',
  BTC_TOKEN: process.env.NEXT_PUBLIC_BTC_TOKEN || '0x5b3578d284bEbcb15037567A49Ce855A636fff4E',
  
  // Core Liquid Pool
  CORE_LIQUID_POOL: process.env.NEXT_PUBLIC_CORE_LIQUID_POOL || '0x1234567890123456789012345678901234567890',
  
  // TULL Contracts
  SIMPLE_TULL: process.env.NEXT_PUBLIC_SIMPLE_TULL_ADDRESS || '0x0B306BF915C4d645ff596e518fAf3F9669b97016',
  OPTIMIZED_TULL: process.env.NEXT_PUBLIC_OPTIMIZED_TULL_ADDRESS || '0xc6e7DF5E7b4f2A278906862b61205850344D4e7d',
